...
\caption{Mean intervention Shapley values across the 125 joint Latin-hypercube decisions. Error bars show the descriptive standard deviation across the predeclared stress design and seeds; they are not population confidence intervals.}
\label{fig:lhs}
\end{figure}
