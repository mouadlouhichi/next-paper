...
\end{equation}
where the candidate set is fixed from the full model and $y_u$ is the temporal test target. The empty coalition is a zero profile with a deterministic tie-break.
