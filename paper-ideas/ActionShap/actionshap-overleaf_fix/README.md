...
ActionShap package. The source repository is public at
`https://github.com/mouadlouhichi/next-paper`; a DOI-backed archive deposit remains
a release action. Numerical assets trace to result-generation commit `0673378`,
and the archive SHA-256 is recorded in `release/archive_sha256.txt`.
