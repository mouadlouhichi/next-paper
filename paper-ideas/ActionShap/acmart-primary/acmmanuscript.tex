...
The submission package includes the editable LaTeX tables and vector figures used in the manuscript. The accompanying artifact will contain the generation code, configurations, preprocessing and execution scripts, validation reports, provenance manifest, and machine-readable result matrices. \textbf{The permanent or reviewer-view artifact URL must be inserted here before submission.}
