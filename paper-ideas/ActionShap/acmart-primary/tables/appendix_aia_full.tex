...
\caption{Complete singleton alignment matrix for all declared ItemKNN conditions. Means are distinct-user values; confidence intervals and missing-user counts are retained in the CSV release.}\label{tab:S1}\\
\toprule
