...
\textbf{Sequential-model recommendation quality.} The replication SASRec, trained under the minimal cohort protocol, ranks below popularity on both datasets (Table~\ref{tab:review5-sasrec-quality}: Amazon NDCG@10 $0.0002$ vs $0.0074$ popularity; ML-1M $0.0019$ vs $0.0191$), and fails the Amazon masking gate. Its role in this paper is therefore attribution transfer under a sequential architecture, not competitive recommendation; a full-corpus-trained sequential audit is the declared follow-up (Appendix~\ref{app:release} records the training protocol).
