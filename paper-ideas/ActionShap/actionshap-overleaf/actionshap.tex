...
All paths in generated manifests are repository-relative and all release archives are verified by SHA-256. Code, configuration files, validation reports, preprocessing/run scripts, and machine-readable result matrices are included in the package's \texttt{release/} directory and the repository release. This manuscript and supplement are generated from source commit \texttt{0673378}; the schema-v2 result archive has SHA-256 \texttt{ac4c7fb1993458b6b41054974ebff215710e7a8b5894c7aa6af828e94b2a5b0f}. The source repository URL is https://github.com/mouadlouhichi/next-paper; its public visibility and any DOI-backed deposit remain external release actions.
