...
\begin{appendices}
% Explicit alphabetic appendix lettering: A--F are the only manuscript appendices.
...
\texttt{tables/actionability\_gap\_advantage.csv}; they are not duplicated as a dense PDF export.
