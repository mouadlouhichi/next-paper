...
\caption{Primary ItemKNN alignment components. Values are distinct-user means; the bounded-AIA and Gap columns carry 95\% user-bootstrap confidence intervals, while deletion-AIA intervals are provided in \texttt{aia\_components.csv} and the release. Abbreviations: Shapley = Monte Carlo Shapley; Greedy = greedy sequential deletion; Random = random control.}
