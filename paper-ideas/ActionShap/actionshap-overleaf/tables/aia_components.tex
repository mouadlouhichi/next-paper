...
\caption{Primary ItemKNN alignment components. Values are distinct-user means with 95\% user-bootstrap confidence intervals; complete intervals and missing-user counts for every condition are provided in the release. Abbreviations: Shapley = Monte Carlo Shapley; Greedy = greedy sequential deletion; Random = random control.}
