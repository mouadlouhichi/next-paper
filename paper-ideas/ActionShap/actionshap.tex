% LEGACY CROSS-DOMAIN LATEX DRAFT -- NOT THE CANONICAL RECOMMENDATION-ONLY PAPER.
% Use ActionShap_Recommendation_Paper_Structure.md for the current manuscript plan.
