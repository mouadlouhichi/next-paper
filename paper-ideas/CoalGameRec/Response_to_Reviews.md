...
| 1.3 — **DyHuCoG reproducibility circularity** | Candid treatment: disclose a pinned re-specification or decouple the worked example from the benchmark; audit described as an author-side risk, not a field fact | `Implementation_Spec.md` §A.4; `Paper_Structure.md` dependency note |
