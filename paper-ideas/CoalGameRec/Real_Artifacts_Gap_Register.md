...
| **Fixed item-vector construction** | Sparse train-only item-user matrix `x_i`, L2 normalization, dimensions, sparsity, hash, and memory/cosine-computation report. | Missing |
